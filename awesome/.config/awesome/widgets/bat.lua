...
local text = wibox.widget {
    id = "txt",
    -- font = "Play 6",
    -- font = "Comfortaa Bold 6",
    -- font = "Open Sans SemiBold 6",
    font = "Fira Sans SemiBold 6",
...
local batt_widget, batt_timer = watch("acpi", 10,
...
-- battery_popup = awful.tooltip({objects = {batteryarc_widget}})
...
return wibox.container.mirror(batt_widget, { horizontal = true })
